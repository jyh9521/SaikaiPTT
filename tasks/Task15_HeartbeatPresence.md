...
- Heartbeat separated from discovery.
- Configurable heartbeat interval.
- Multiple missed intervals required before Offline.
- Track lastSeen.
- Peer recovery from Offline to Online.

## Acceptance Criteria

One missed heartbeat does not immediately mark Offline.
Repeated missing heartbeats do.
