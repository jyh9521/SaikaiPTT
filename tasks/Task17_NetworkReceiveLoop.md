...
- malformed packet isolation
- no UI dependency

Do not implement full voice session handling yet.

## Acceptance Criteria

Control packets can be received and dispatched through a testable event interface.
