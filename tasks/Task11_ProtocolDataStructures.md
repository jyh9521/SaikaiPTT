...
Keep serialization transport-independent.

## Acceptance Criteria

- Valid packet encode/decode round trips.
- No network socket dependency in protocol models.
- Unit tests cover representative packet types.
