...
- No hard-coded user-facing strings in newly created UI/business code.
- Establish resource conventions.
- Establish locale switching architecture.
- Use Japanese as default.
- Prepare notifications/overlay strings for localization.

## Acceptance Criteria

A small internal/demo surface can render all five locales without layout-breaking obvious issues.
